...
idx3 = np.logical_and(idxrun72, idx3) #Already includes 73
...
e1Bounds = np.logical_and(e2pos >= 3.6, e2pos < 5.8)
all_bins_wavs = []
all_bins_idx = []
...
plt.plot(big_mean_wav, label = "Bigger Median")
...
plt.plot(sml_mean_wav, label = "Bigger Median")
